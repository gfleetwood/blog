...
# Bring in the heavy guns to apply the coup de grace and produce the combined file
ffmpeg -f concat -safe 0 -i mp3-files.txt -c copy output-final.mp3
```

Success!

It lacks the sophistication of a robust pipeline but it works. Maybe I'll make an auto audio book srvice. You can find the pdf [here](https://archive.org/details/CarrollQuigley-TheEvolutionOfCivilizations-AnIntroductionTo/mode/2up) and the mp3 [here](https://drive.google.com/open?id=1LF0sS0gEhleakG6BEB8ItY47pUlro738).