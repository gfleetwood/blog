...
It lacks the sophistication of a robust pipeline but it works. Maybe I'll make an auto audio book srvice. You can find the pdf [here](https://archive.org/details/CarrollQuigley-TheEvolutionOfCivilizations-AnIntroductionTo/mode/2up) and the mp3 [here]().